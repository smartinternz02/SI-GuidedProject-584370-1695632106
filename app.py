...
app = Flask(__name__)
app.secret_key = 'a'
conn = ibm_db.connect("DATABASE=bludb; HOSTNAME=19af6446-6171-4641-8aba-9dcff8e1b6ff.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud; PORT=30699; UID=smm34240; PASSWORD=X5xiTLGkastJEVmZ; SECURITY=SSL;SSLServerCertificate = DigiCertGlobalRootCA.crt", "", "")
    ...
    if request.method=="POST":
       for x in range (1,5):
        ...
        if f.filename != '':
            ...
            COS_API_KEY_ID = "hmfAPLmTVyUDUTdweYfVSuLkX52ntNkJXztKXoe7dnzy"
            COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/95a24b6c7767425d85cd4bb38b46e4aa:30b72b4a-e6ca-4af0-9d6f-f1526bcb5666::"
            ...
            cos.meta.client.upload_file(Filename= filepath,Bucket='saddibucket',Key= u+x+".pdf")
...
def marksassign(stdname):
    ...
    output = cos.list_objects(Bucket="saddibucket")
    output
    l=[]
